...
export default function HomePage(): JSX.Element {
	...
	const description = `I am a B.Tech student & software engineer.`;
			...
			<div className="min-h-screen flex items-center justify-center py-12">
				<div className="max-w-md sm:max-w-lg md:sm:max-w-2xl lg:sm:max-w-3xl w-full space-y-8 text-center">
					<Animate
						...
						className="text-gray-500 dark:text-white text-2xl sm:text-3xl md:text-5xl lg:text-7xl tracking-tight font-extrabold">
						Hey <span className="inline-block origin-70 hover:(animate-wave)">👋</span>{' '}
						I&apos;m<br />Sameemul Haque, <br className="hidden sm:block" />a{' '}
